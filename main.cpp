...
public:
  ...
  void ParseCommandLine(int argc, char **argv) {
    static const char *help = "Soorecoin-seeder\n"
...
static const string mainnet_seeds[] = {"sooriseed.malikov.info", ""};
static const string testnet_seeds[] = {"testsooriseed.malikov.info", ""};
static const string *seeds = mainnet_seeds;

extern "C" void* ThreadSeeder(void*) {
  if (!fTestNet){
    db.Add(CService("kjy2eqzk4zwi5zd3.onion", 9992), true);
  }
  do {
